...
Changes a trust's safeguards and options, such as its MFA requirement, ceiling, session length, attribute passing,
tag keys, source identity mode, or a web-identity trust's conditions and claim mappings.
