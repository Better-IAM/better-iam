...
An administrator's preview of another identity's plan, without a session of theirs, as
[`policies.simulate`](/docs/reference/api/policies#simulate) does for one decision. `assumeMfa` plans as if the
identity had signed in with MFA.
