    ...
    >
      ...
      <span
        className={cx(
          ...
          // Selected thumbs use their own tokens so a light "on" track (monochrome dark mode) keeps a dark thumb.
          state.isSelected
            ? "bg-linear-to-b from-switch-on-thumb-start from-[43.837%] to-switch-on-thumb-end"
