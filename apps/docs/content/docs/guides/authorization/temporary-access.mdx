...
description: Access that ends, starts later, or applies only in business hours, plus access requests, role sessions, session tokens, web-identity federation for workloads, and expiring API keys.
icon: Hourglass
