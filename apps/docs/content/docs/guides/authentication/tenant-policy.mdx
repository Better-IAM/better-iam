...
description: Per-organization sign-in rules - required MFA, allowed methods, password rules, session limits, remembered devices, IP allowlists, session binding, and network blocks.
